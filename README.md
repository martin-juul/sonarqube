# martinjuul/sonarqube

Sonarqube contantainers for unpublished versions
...
```shell
docker run martinjuul/sonarqube:7.9.3-developer
```
...
|:------------------------|:---------------------------|:---------------|
| SONARQUBE_HOME          | sonarqube installation dir | /opt/sonarqube |
| SONARQUBE_JDBC_USERNAME | username for db connection | ""             |
| SONARQUBE_JDBC_PASSWORD | password for db connection | ""             |
| SONARQUBE_JDBC_URL      |                            | ""             |

If you don't specify a SONARQUBE_JDBC_URL, sonarqube will default to h2 as the datastore.
You can still set username and password.

#### Volumes

* `$SONARQUBE_HOME/data` - Database etc..
